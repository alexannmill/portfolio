...
function App() {
    return (React.createElement("div", { className: "App" },
        ...
        React.createElement("a", { id: "home" }),
        React.createElement(Home_1.default, null),
        React.createElement("a", { id: "skills" }),
        React.createElement(Skills_1.default, null),
        React.createElement("a", { id: "projects" }),
        React.createElement(Projects_1.default, null),
        React.createElement("a", { id: "blog" }),
        React.createElement(BeerBlog_1.default, null),
        React.createElement("a", { id: "contact" }, "."),
